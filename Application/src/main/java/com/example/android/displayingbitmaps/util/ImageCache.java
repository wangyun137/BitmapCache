...
public class ImageCache {
    ...
    //TODO:CompressFormat是Bitmap压缩类型的枚举类
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache == null || mDiskLruCache.isClosed()) {
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    //TODO:如果diskCacheDir的可用空间大于10MB
    ...
    public static class ImageCacheParams {
        public int memCacheSize = DEFAULT_MEM_CACHE_SIZE;//默认的内存缓存大小5MB
        public int diskCacheSize = DEFAULT_DISK_CACHE_SIZE;//默认的磁盘缓存大小为10MB
        public File diskCacheDir;//磁盘缓存文件夹,/sdcard/Android/data/com.example.android.displayinbitmaps/thumbs
        public CompressFormat compressFormat = DEFAULT_COMPRESS_FORMAT;//图片默认压缩格式为JPEG
        public int compressQuality = DEFAULT_COMPRESS_QUALITY;//图片压缩质量，70
        public boolean memoryCacheEnabled = DEFAULT_MEM_CACHE_ENABLED;//内存缓存为true
        public boolean diskCacheEnabled = DEFAULT_DISK_CACHE_ENABLED;//磁盘缓存为true
        public boolean initDiskCacheOnCreate = DEFAULT_INIT_DISK_CACHE_ON_CREATE;//在onCreate的时候初始化磁盘缓存为false
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        android.util.Log.d("wy","ExternalCacheDir->" + getExternalCacheDir(context));
